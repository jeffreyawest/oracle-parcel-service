function from(){
    ...
    if (reason == "") {
        $("#from_address_table").replaceWith("<table id='to_address_table' ><tr><th colspan='2'> Receipient  Information</th></tr><tr><td><label for='to_addressee'>In Care of: *</label></td><td><input type='text' name='to_addressee' id='to_addressee' onblur='validateEmpty(to_addressee)'/></td></tr><tr><td><label for='to_addressLine1'>Address Line 1: *</label></td><td><input type='text' name='to_addressLine1' id='to_addressLine1' onblur='validateEmpty(to_addressLine1)'/></td></tr><tr><td><label for='to_addressLine2'>Address Line 2:</label></td><td><input type='text' name='to_addressLine2' id='to_addressLine2'/></td></tr><tr><td><label for='to_city'>City :</label></td><td><input type='text' name='to_city' id='to_city'/></td></tr><tr><td><label for='to_state'>State :</label></td><td><input type='text' name='to_state' id='to_state'/></td></tr><tr><td><label for='to_postalCode'>Postal Code :</label></td><td><input type='text' name='to_postalCode' id='to_postalCode' onblur='validateEmpty(to_postalCode)'/></td></tr><tr><td><button type='button' onclick='fromback()' style='background-color: #74b0c6;font-family:Helvetica,Arial,Verdana,sans-serif;'>Back</button></td><td><img src='image/next-icon.png' style='height: 40px; width: 40px;position: relative;left: 100px;' onclick='to()'/></td></tr></table>");
