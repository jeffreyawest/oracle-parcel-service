...
@XmlType(name = "AddressType", namespace = "http://demo.oracle.com/ops/domain/schema/common", propOrder = {
    "addressee",
    "addressLine1",
    "addressLine2",
    "city",
...
@XmlRootElement(name = "Address", namespace = "http://demo.oracle.com/ops/domain/schema/common")
