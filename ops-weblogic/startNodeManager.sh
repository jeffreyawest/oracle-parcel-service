...
export WL_HOME="/u01/wls1212/wlserver_12.1"
...
export ﻿CLASSPATH="${CLASSPATH}:${MW_HOME}/modules/features/weblogic.server.modules_12.1.1.0.jar"
export ﻿CLASSPATH="${CLASSPATH}:${MW_HOME}/modules/org.apache.ant_1.7.1/lib/ant-all.jar"
export ﻿CLASSPATH="${CLASSPATH}:${MW_HOME}/modules/net.sf.antcontrib_1.1.0.0_1-0b2/lib/ant-contrib.jar"
...
export SERVER_ARGS="${SERVER_ARGS} -Djava.security.policy=${WL_HOME}/server/lib/weblogic.policy"
