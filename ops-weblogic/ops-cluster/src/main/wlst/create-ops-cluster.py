...
appDatasource_JndiName = 'com.oracle.demo.ops.app-ds'
appDatasource_GlobalTransactions = 'None'
appDatasource_JdbcDriver = 'oracle.jdbc.OracleDriver'

database_User = 'ops_user'
database_Password = 'ops_user'
...
def configureDomain_online():
  ...
  createWorkManager('wm/CoherenceWorkManager')


def createWorkManager(wmName):
  cd('/SelfTuning/' + domain_Name)
  cmo.createWorkManager(wmName)

  cd('/SelfTuning/' + domain_Name + '/WorkManagers/' + wmName)
...
try:
  ...
  createApplicationDataSource([appDatasource_JndiName],
                                                   appDatasource_JdbcDriver,
                                                   appDatasource_GlobalTransactions,
                                                   datasource_jdbc_url,
                                                   database_User,
